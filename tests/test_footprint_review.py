...
def test_render_footprint_review_report_groups_counts_and_suggestions(tmp_path):
    ...
    (tmp_path / "unit_footprint_review_queue.csv").write_text(
        "\n".join(
            [
                "review_rank,review_priority,unit_id,unit_name,faction_contains,suggested_guide_unit_name,suggested_base_size_text",
                "1,review_suggestion_high,u2,Legacy Captain,Imperium - Space Marines,Captain,40mm",
